...
let mat3 = Material.make (Color.randColor()) 0.3 0.7 0.6;;
let sphere3 = Sphere.make (vec3f 3. 0. 3.) 2. mat3;;
let sphere3 = Object.Sphere_(sphere3);;

let matPlane = Material.make (Color.make 0.67 0.85 1.) 0.0 ~mirror:1.0 0.2 0.3;;
let plane1 = Plane.make (vec3f 0. (-2.) 0.) (Vec3f.norm(vec3f 0. 1. 0.)) matPlane;;
let plane1 = Object.Plane_(plane1)
let light1 = LightSource.make @@ vec3f (-30.) (10.) 20.;;
let light2 = LightSource.make @@ vec3f 10. 8. (-10.)

let matW = Material.make (Color.make 0.5 0.5 0.5) 0. 0.7 0.;;
let world = World.make [sphere1; sphere2; sphere3; plane1] [light1; light2] matW;;
trace camera world
